  ...
  return (
    ...
    >
      ...
      <div className="font-serif text-[2.5rem] leading-[1.05] sm:text-5xl md:text-6xl lg:text-7xl font-bold tracking-tight mb-4 md:mb-6 flex flex-col items-center relative z-20">
        ...
        />
        <BlurText
          text="la visibilité qu'elle mérite"
          delay={60}
          initialDelay={0.3}
          animateBy="words"
          direction="top"
      ...
      <motion.div variants={fadeInUp} className="flex flex-col items-center justify-center mb-16 h-36">
        ...
        <div className="inline-flex items-center gap-3 px-4 py-2 mt-4 bg-white/5 rounded-full border border-white/10">
          <span className="text-sm font-medium text-white">Client Reviews</span>
      ...
      <motion.div 
        variants={fadeInUp}
        className="relative mx-auto rounded-3xl overflow-hidden shadow-2xl shadow-primary/10 max-w-4xl aspect-video bg-gray-900 cursor-pointer group"
        onClick={togglePlay}
      >
        <video 
          ref={videoRef}
